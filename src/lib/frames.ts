...
export const FRAMES: FrameConfig[] = [
  { file: "frame1.png", label: "Ornate Gold",   aspect: 3/4, shape: "rect",   innerPadding: { top: 14, right: 13, bottom: 14, left: 13 } },
  ...
  { file: "frame5.png", label: "Heart",         aspect: 1/1, shape: "circle", innerPadding: { top: 18, right: 18, bottom: 18, left: 18 } },
