...
export const FRAMES: FrameConfig[] = [
  ...
  { file: "polaroid/film.png",            label: "Film",            category: "polaroid", aspect: 334/468, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.075, right: 0.137, bottom: 0.167, left: 0.164 } },
  ...
  { file: "polaroid/film1.png",           label: "Film 1",          category: "polaroid", aspect: 350/374, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.182, right: 0.103, bottom: 0.218, left: 0.123 } },
  ...
  { file: "digis/angel-tama.png",    label: "Angel Tama",    category: "digis", aspect: 326/352, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.368, right: 0.348, bottom: 0.334, left: 0.340 } },
  { file: "digis/apple-tama.png",    label: "Apple Tama",    category: "digis", aspect: 469/372, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.232, right: 0.250, bottom: 0.310, left: 0.178 } },
  { file: "digis/blue-digi.png",     label: "Blue Digi",     category: "digis", aspect: 616/400, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.012, right: 0.344, bottom: 0.117, left: 0.023 } },
  { file: "digis/blue-tama.png",     label: "Blue Tama",     category: "digis", aspect: 429/475, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.240, right: 0.086, bottom: 0.238, left: 0.266 } },
  ...
  { file: "digis/pink-tama.png",     label: "Pink Tama",     category: "digis", aspect: 456/472, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.240, right: 0.118, bottom: 0.286, left: 0.176 } },
  { file: "digis/pink2-tama.png",    label: "Pink 2 Tama",   category: "digis", aspect: 461/513, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.252, right: 0.097, bottom: 0.229, left: 0.179 } },
  { file: "digis/plaid-tama.png",    label: "Plaid Tama",    category: "digis", aspect: 397/524, shape: "rect", innerPadding: { top: 10, right: 10, bottom: 10, left: 10 }, cropPadding: { top: 0.100, right: 0.253, bottom: 0.322, left: 0.263 } },
